  ...
  const officialResources = [
    {
      ...
      description: "The official website of the University of California's Investment Office.",
      icon: "mdi:web",
      href: "https://www.ucop.edu/investment-office/index.html"
    },
    {
      title: "2023-2024 Annual Report",
      description: "Comprehensive annual report detailing the UC's investment performance, asset allocation, and financial strategies for the fiscal year.",
      icon: "mdi:file-chart",
      href: "https://www.ucop.edu/investment-office/annual-report-240923_ucar24_final.pdf"
    },
    {
      title: "Investment Philosophy",
      description: "The 10 pillars guiding UC's investment strategy, including their approach to risk management, asset allocation, and long-term value creation. It's a slideshow very quick read.",
      icon: "mdi:lightbulb-on",
      href: "https://www.ucop.edu/investment-office/10pillarspowerpoint-1.pdf"
    },
    {
      title: "SEC 13F Filings",
      description: "Quarterly SEC Form 13F-HR filings showing UC's institutional investment holdings. These regulatory filings provide detailed disclosure of equity positions managed by the UC.",
  ...
  const criticalAnalysis = [
    {
      ...
      description: "An in-depth critical examination of UC's investment practices by our friends over at UCLA. It clearly explains what the UC is invested in and what our money funds.",
    ...
    },
    {
      ...
      description: "A comprehensive analysis examining the power structures and decision-making processes within the UC system. This paper explores the relationships between UC governance, UC investments, and the economic/political influences on university policy.",
        ...
        <div class="resources-grid">
          {#each officialResources as resource}
            <Card hover padding="2rem">
              ...
              <Button href={resource.href} external>
                View Resource
              </Button>
            </Card>
          {/each}
          ...
          <div class="related-links">
            {#each relatedLinks as link}
              <div class="link-item">
                ...
                <div>
                  <Button href={link.href} variant="secondary" external={link.external}>
                    {link.title}
                  </Button>
